...
let MetricsCalculator = class MetricsCalculator {
     ...
     * @param data
     */
    calculateMetrics(url, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                logger_1.default.debug(`Calculating metrics for ${url}...`);
                const [busFactor, correctness, rampUp, responsiveMaintainer, pullRequest] = yield Promise.all([
    ...
    calculatePercentPullRequest(pullRequestData) {
        return __awaiter(this, void 0, void 0, function* () {
            //TO IMPLEMENT:
