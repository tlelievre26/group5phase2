...
exports.getPkgByRegex = exports.deletePkgByName = exports.getPkgHistoryByName = exports.ratePkgById = exports.createPkg = exports.deletePkgById = exports.updatePkgById = exports.getPkgById = exports.getPackageQuery = void 0;
...
exports.getPackageQuery = getPackageQuery;
...
exports.getPkgById = getPkgById;
const updatePkgById = (req, res) => {
...
exports.updatePkgById = updatePkgById;
const deletePkgById = (req, res) => {
    const id = req.params.id;
    const auth_token = req.params.auth_token;
    var response_code = 200; //Probably wont implement it like this, just using it as a placeholder
    if (response_code == 200) {
...
exports.deletePkgById = deletePkgById;
...
exports.ratePkgById = ratePkgById;
const getPkgHistoryByName = (req, res) => {
...
exports.getPkgHistoryByName = getPkgHistoryByName;
const deletePkgByName = (req, res) => {
    const name = req.params.name;
    const auth_token = req.params.auth_token;
    var response_code = 200; //Probably wont implement it like this, just using it as a placeholder
    if (response_code == 200) {
...
exports.deletePkgByName = deletePkgByName;
const getPkgByRegex = (req, res) => {
...
exports.getPkgByRegex = getPkgByRegex;
